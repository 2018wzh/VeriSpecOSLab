...
export async function executeAgentImplement(
  ...
  try {
    ...
    taskPrompt += "\nThe hard maxIterations value remains 50. The final two iterations are reserved for structured completion: if the iteration-49 submission is rejected, iteration 50 restores the full tool set so you can repair and resubmit in the same response.";
