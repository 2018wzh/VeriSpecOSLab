...
export async function executeAgentImplement(
  ...
  try {
    ...
    taskPrompt += "\nThe earlier iteration-30 submission guidance is superseded: finish implementation and tests, then submit no later than iteration 45. The hard maxIterations value remains 50. During the final five iterations, a rejected structured submission is returned to this same thread for a full-tool repair turn before submit_result is required again.";
