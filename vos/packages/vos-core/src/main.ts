  ...
  try {
    ...
    while (remainingIterations > 0) {
      ...
      const agentResult = await runAgentWithPrompt({
        ...
        completionReserveIterations: threadId ? 2 : 25,
