...
export async function executeAgentImplement(
  ...
  try {
    ...
    taskPrompt += `\nThe hard maxIterations value is ${implementationMaxIterations}. There is no fixed first-submission iteration: submit as soon as the work is complete. Rejected submissions restore the full tool set, and iteration ${implementationMaxIterations} requires a final corrected submission.`;
