...
integration("course manifests publish immutable snapshots, rollback, and import grouped enrollment", async () => {
  ...
  const manifest = (specVersion: string): CourseManifestV1 => ({
    ...
    stages: [
      { id: "boot", key: "boot", name: "Boot", sequence: 0, source_ref:"course/lab1-complete",spec_refs:["kernel.boot"],test_sets:["boot.public"],rubric_ids:["correctness"],hardware_gate:"none",human_review_required:false,required_artifacts: ["serial.log"], required_evidence: [], required_review_artifacts: [], manual_review_required: false },
      { id: "memory", key: "memory", name: "Memory", sequence: 1, source_ref:"course/lab2-complete",spec_refs:["kernel.memory"],test_sets:["memory.public"],rubric_ids:["correctness","design"],hardware_gate:"none",human_review_required:false,required_artifacts: [], required_evidence: [{ suite: "memory", case_name: "map", required_result: "pass" }], required_review_artifacts: [], manual_review_required: true },
    ],
