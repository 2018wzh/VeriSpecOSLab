...
integration("enrollment, Gitea push, isolated verification, immutable grading and appeal form one teaching cycle", async () => {
  ...
  try {
    ...
    const manifest:CourseManifestV1={version:"course-manifest.v1",course:{code:`VOS-${suffix}`,name:"Connected Teaching Cycle",term:"e2e"},experiment:{id:`lab-${suffix}`,title:"Portal teaching fixture",spec_version:"v1"},stages:[{id:"boot",key:"boot",name:"Boot",sequence:0,required_artifacts:["build/result.txt"],required_evidence:[],manual_review_required:false}],rubric:[{id:"public-verification",name:"Public verification",weight:100}],ai_policy:{allowed_models:["school-default"],monthly_budget:10,allow_byok:true}};
