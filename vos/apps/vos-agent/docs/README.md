...
This directory contains the formal documentation for `stars`.
...
1. [**Getting started**](getting-started.md) — install, configure, run
   interactive/headless Stars, and write a custom tool in fewer than
   fifty lines.
...
10. [**TUI evaluation**](tui-evaluation.md) — tmux setup, manual UX
    checklist, latency benchmarks, and feedback template for the Stars
    terminal UI.
