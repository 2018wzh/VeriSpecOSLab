...
学生 CLI 只暴露 init、doctor、spec lint、agent config/ask/review/implement/debug/verify、命令式 KB 管理、build、QEMU、hardware、verify、report 和 submit。Portal/Demo 与暂留的 HTTP 服务属于冻结内部边界，不是学生主链。
