...
**首次进入**：先读本页 → 回到 [Book 第 1 章](book/ch01-overview-design.md) 了解课程全貌 → 打开 [Lab 1](labs/lab1-seed.md)，按其中的 0 起点流程安装 `vos`、初始化项目、理解 OS 背景、选择语言/ISA 并创建 Seed 骨架。
...
**关于语言**：本指导书支持 C、Rust、Zig 等系统编程语言。语言选择的考量在[第 1 章](book/ch01-overview-design.md)中详细说明。
