...
> **对应实验**：[Lab 3: 内存管理](../labs/lab3-memory.md)
...
裸机上，"在哪里放什么"是芯片制造商替你决定好的。OS 上，**"虚拟地址空间怎么布局"是你必须做的设计决策**——这是你在阶段 1 的 DesignSpec 中不需要回答、但在阶段 3 必须回答的核心问题。你的内核代码放哪？你的内核栈放哪？用户程序的代码、堆、栈各自放哪？这些地址不能冲突，且必须和你的页表设计一致。
