...
- [x] Remove frontend runtime mock fallback; demo data now comes from backend seed data only.
...
- [x] Show audit timeline in the frontend.
...
- [x] Add Docker Compose for Postgres, backend, frontend, Gitea, and runner.
